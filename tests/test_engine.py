...
from tests.helpers import get_callsite_by_addr
    ...
    def test_engine_mipsel_1(self):
        ...
        expected_callsites = {
            ...
            CallSite(
                0xA34,
                0xF3C,
                frozendict({0: MemoryAccess(0xA34, Register(112, 0xA34), 0, MemoryAccessType.LOAD)}),
            ),
...
class TestEngineMIPSBE:
    ...
    def test_many_load_memory_access_sanity(self):
            ...
            frozendict(
                {
                    ...
                    1: 0xFFFF,
                    2: 4098,
                    3: BinaryOp(Register(116, 0x00427960), 0xFFFFFFF4, "+"),
                    4: BinaryOp(Register(116, 0x00427960), 0xFFFFFFF0, "+"),
                }
            ),
        )
    ...
    def test_return_value_constant_number(self):
        # EVP_aes_128_ccm in sshd binary
        CODE = b"\x3c\x02\x00\x5e\x03\xe0\x00\x08\x24\x42\xc7\x74"
        ADDR = 0x004924E4
    ...
    def test_return_value_constant_number_multiple_times(self):
        # aes_ccm_init_key in sshd binary
        CODE = b""
        ADDR = 0x00492128
    ...
    def test_return_value_function_call_from_single_block(self):
    ...
    def test_return_value_is_arithmetic_expression(self):
        # sshd binary `err_state_LHASH_HASH` function
        CODE = b"\x3c\x1c\x00\x5f\x27\xbd\xff\xe0\x27\x9c\x27\xe0\xaf\xbf\x00\x1c\xaf\xbc\x00\x10\x8f\x99\x94\x9c\x03\x20\xf8\x09\x00\x00\x00\x00\x24\x03\x00\x0d\x8f\xbf\x00\x1c\x27\xbd\x00\x20\x03\xe0\x00\x08\x70\x43\x10\x02"
        ADDR = 0x0048CB98
    ...
    def test_multiple_return_values(self):
        # sshd binary `file_read` function
        CODE = b""
        ADDR = 0x0048AC44
    ...
    def test_return_value_is_memory_access(self):
        # sshd binary `BIO_set_flags` function
        CODE = b"\x8c\x82\x00\x14\x00\x45\x28\x25\x03\xe0\x00\x08\xac\x85\x00\x14"
        ADDR = 0x00489628
